...
# Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope LocalMachine -ErrorAction Continue | Out-Null
...
# Calculate the maximum value between $size.SizeMax and 1MB (1048576 bytes)
$maxSize = [Math]::Max([int64]$size.SizeMax, 1048576)
